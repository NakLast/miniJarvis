...
- Text to speech
  - ... waiting. (Testing speechSynthesis(https://dev.to/asaoluelijah/text-to-speech-in-3-lines-of-javascript-b8h#:~:text=var%20msg%20%3D%20new%20SpeechSynthesisUtterance()%3B,speak(msg)%3B))
- Ai avatar
